...
**Objective:** Create a cyclic graph, and given an input from a stack, traverse to visit different nodes.

*Note:* These algorithms are part o a larger project about [VR teleportation.](https://github.com/DavidGiraldoCode/s-Evaluating_VR_teleportation_under_stressful_gameplay)
...
- Creating a cycle graphcan be done in a fairly simple fashion, I was overcomplicating things. The contructor is as follows:
